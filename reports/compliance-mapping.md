...
| ISO 42001 Clause 5-6 | Policy-as-code có input rõ, deny rule, reason bắt buộc và lịch sử review bằng commit riêng. | `agent/policy.py:39-61`; commit `ded7ea8` (`git log -- agent/policy.py`) |
